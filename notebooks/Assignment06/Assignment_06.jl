...
\$\\begin{aligned}
&P(y) = \\frac{3}{(1+\\frac{1\\%}{2})^{2\\times 0.5}} + \\frac{103}{(1+\\frac{1.2\\%}{2})^{2\\times 0.5}} = 104.76\\\\
&P(y + \\Delta y) = \\frac{3}{(1+\\frac{1.1\\%}{2})^{2\\times 0.5}} + \\frac{103}{(1+\\frac{1.3\\%}{2})^{2\\times 0.5}}= 104.6575\\\\
&P(y - \\Delta y) = \\frac{3}{(1+\\frac{0.9\\%}{2})^{2\\times 0.5}} + \\frac{103}{(1+\\frac{1.1\\%}{2})^{2\\times 0.5}}= 104.8528\\\\
